              ...
              <div className="mt-6 space-y-6">
                ...
                <div>
                  <div className="group relative overflow-hidden rounded-lg bg-light p-4 pb-0 dark:bg-dark-2 md:p-6 md:pb-0 xl:p-10 xl:pb-0">
                    <div className="relative aspect-6/4 overflow-hidden rounded-t-lg">
                      <Link
                        href="https://dugoutgg.vercel.app/"
                      ...
                      >
                        <Image
                          src="/assets/img/portfolio/dugout.png"
                          alt="The Dugout - Website Design | Website Development"
                          width={1920}
                          height={1080}
                  ...
                  <div className="flex flex-wrap items-start justify-between py-4 md:p-6">
                    ...
                    {/* <Link
                      href="https://github.com/noone-21/TextManipulator"
                ...
                <div>
                  <div className="group relative overflow-hidden rounded-lg bg-light p-4 pb-0 dark:bg-dark-2 md:p-6 md:pb-0 xl:p-10 xl:pb-0">
                    <div className="relative aspect-6/4 overflow-hidden rounded-t-lg">
                      <Link
                        href="https://stumpexgg.vercel.app/"
                        className="border-b border-transparent text-dark transition hover:border-b-primary hover:text-primary dark:text-light/80 dark:hover:text-primary"
                      >
                        <Image
                          src="/assets/img/portfolio/stumpex.png"
                          alt="Stumpex"
                          width={1920}
                          height={1080}
                          className="h-full w-full rounded-t-lg object-cover object-top transition"
                  ...
                  <div className="flex flex-wrap items-start justify-between py-4 md:p-6">
                    <div>
                      <h3 className="text-lg font-medium md:text-xl lg:text-2xl">
                        <Link
                          href="https://text-analyzer.surge.sh/"
                          className="border-b border-transparent text-dark transition hover:border-b-primary hover:text-primary dark:text-light/80 dark:hover:text-primary"
                        >
                          StumpEx
                        </Link>
                      ...
                      <p className="text-sm text-muted lg:text-base">
                        Discord Bot | API Development | Website Design
                      </p>
                    </div>
                ...
                <div>
                  <div className="group relative overflow-hidden rounded-lg bg-light p-4 pb-0 dark:bg-dark-2 md:p-6 md:pb-0 xl:p-10 xl:pb-0">
                    <div className="relative aspect-6/4 overflow-hidden rounded-t-lg">
                      <Link
                        href="https://pixarsart-homepage.vercel.app/"
                        className="border-b border-transparent text-dark transition hover:border-b-primary hover:text-primary dark:text-light/80 dark:hover:text-primary"
                      >
                        <Image
                          src="/assets/img/portfolio/Pixarsart.png"
                          alt="Pixarsart - Website Design | Website Animations"
                          width={1920}
                          height={1080}
                          className="h-full w-full rounded-t-lg object-cover object-top transition"
                        />
                  ...
                  <div className="flex flex-wrap items-start justify-between py-4 md:p-6">
                    <div>
                      ...
                      <p className="text-sm text-muted lg:text-base">
                        Website Design | Website Animations
                      </p>
                    </div>

                    <Link
                      href="https://github.com/noone-21/Pixarsart-Homepage"
                      className="inline-flex items-center justify-center gap-1 rounded bg-white px-3 py-2 text-center text-sm leading-none text-dark transition hover:text-primary dark:bg-black dark:text-light/70 dark:hover:text-primary"
                    >
                      <span>Code Link</span>
                      <svg
                ...
                <div>
                  <div className="group relative overflow-hidden rounded-lg bg-light p-4 pb-0 dark:bg-dark-2 md:p-6 md:pb-0 xl:p-10 xl:pb-0">
                    <div className="relative aspect-6/4 overflow-hidden rounded-t-lg">
                      <Link
                        href="https://fd-chats-client.vercel.app/"
                        className="border-b border-transparent text-dark transition hover:border-b-primary hover:text-primary dark:text-light/80 dark:hover:text-primary"
                      >
                        <Image
                          src="/assets/img/portfolio/FDChats.png"
                          alt="FD Chats - Website Design | Socket Connection"
                          width={1920}
                          height={1080}
                          className="h-full w-full rounded-t-lg object-cover object-top transition"
                        />
                  ...
                  <div className="flex flex-wrap items-start justify-between py-4 md:p-6">
                    <div>
                      ...
                      <p className="text-sm text-muted lg:text-base">
                        UI Design | Website Development | Socket Connection
                      </p>
                    </div>

                    <Link
                      href="https://github.com/noone-21/FDChats-client"
                      className="inline-flex items-center justify-center gap-1 rounded bg-white px-3 py-2 text-center text-sm leading-none text-dark transition hover:text-primary dark:bg-black dark:text-light/70 dark:hover:text-primary"
                    >
                      <span>Client</span>
                      <svg
                    ...
                    <Link
                      href="https://github.com/noone-21/FDChats-server"
                      className="inline-flex items-center justify-center gap-1 rounded bg-white px-3 py-2 text-center text-sm leading-none text-dark transition hover:text-primary dark:bg-black dark:text-light/70 dark:hover:text-primary"
                    >
                      <span>Server</span>
                      <svg
